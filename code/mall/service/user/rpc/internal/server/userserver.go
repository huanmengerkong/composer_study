...
func (s *UserServer) UserReset(ctx context.Context, in *user.LoginRequest) (*user.UserInfoResponse, error) {
	l := logic.NewUserResetLogic(ctx, s.svcCtx)
	return l.UserReset(in)
}
